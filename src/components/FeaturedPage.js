...
export default class FeaturedPage extends React.Component {
        ...
        return (
            <div className="feature-container">
                ...
                <p className="work-subtitle">
                    A simple dating app built with React Native, Redux, Node.js, 
                ...
                <div className="feature-gif-container">
                    ...
                    <div className="feature-gif-item">
                        <img src="images/stagg_swipe_gif.gif" className="feature-gif"/>
                        <p className="feature-gif-caption">like/disliking candiates</p>
                    </div>
                    <div className="feature-gif-item">
                        <img src="images/stagg_matches_gif.gif" className="feature-gif"/>
                        <p className="feature-gif-caption">view matches</p>
                    </div>
                    <div className="feature-gif-item">
                        <img src="images/stagg_profile_gif.gif" className="feature-gif"/>
 ...
 FeaturedPage.propTypes = propTypes;
 FeaturedPage.defaultProps = defaultProps;